...
import { tableIndicatorseleinfo } from "@/api/api";
  ...
  methods: {
    ...
    dataStartAgain() {
      if (this.index === 0) {
        ...
        this.dataStart(
          ["项目编号", "产品名称", "产率"],
          ["projectid", "productionname", "yield"],
          tableIcatorsinfo
        );
      } else if (this.index === 5) {
        this.dataStart(
          ["项目编号", "元素", "品味", "回收率"],
          ["projectid", "element", "percentage", "recoveryrate"],
          tableIndicatorseleinfo
        );
      } else if (this.index === 6) {
        this.dataStart(
        ...
        this.dataStart(
          ...
          '单重','总重','制造厂','电机数量',
          '电机容量','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','length','width',
          'processnum','dmax','upsize','downsize',
          'wetordry','wetwaternum','wetwaterpa',
          'sieveqj','num','singleweight','totalweight',
          'factory','motornum','motorcapacity','remarks'], 
          tableMachinesieve);
      } else if (this.index === 14) {
        this.dataStart(
          ['工程代号','子项代号','作业名称','设备名称',
          '型号','新给矿量','波动系数','循环负荷',
          '磨矿细度','有效容积','最大装球量','冷却水量',
          '冷却水压力','压缩空气量','压缩空气压力','数量',
          '单重','总重','最大检修重','制造厂','电动机数量',
          '电机容量','电机型号','电机类型','是否变频','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','newgkl','bdxs','xhfh',
          'mkxd','yxrj','zdzql','lqsl','lqspa',
          'yskql','yskqpa','num','singleweight','totalweight',
          'zdjxz','factory','motornum','motorcapacity',
          'motorxh','motortype','isbp','remarks'],
          tableMachinemill);
      } else if (this.index === 15) {
        this.dataStart(
          ['工程代号','子项代号','作业名称',
          ...
          '总重','制造厂','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','processnum','gkkjl',
          'bdxs','fjxd','xh','cycnum','diameter',
          'cskzj','ylkzj','qj','d50','fjyl',
          'gknd','ylnd','csnd','xhfh','fhl',
          'num','singleweight','totalweight',
          'factory','remarks'],
          tableMachinecyclone);
      } else if (this.index === 16) {
        this.dataStart(
          ...
          '备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','processnum','kjl',
          'density','ph','bdxs','sjfxsj','fxjxs',
          'shijifxsj','num','singleweight','totalweight',
          'zdjxz','factory','motornum','motorcapacity',
          'motorxh','remarks'],
          tableMachineflotation
        );
        ...
        this.dataStart(
          ...
          '型号','处理量','浓度','矿浆量','细度',
          '设计浮选时间','波动系数','浮选机系数',
          '实际浮选时间','浮选柱承载能力','浮选柱计算承载能力',
          '负荷率','数量','单重','总重','制造厂','电机数量',
          '电机容量','电机型号','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','processnum','density',
          'kjl','fineness','sjfxsj','bdxs','fxjxs',
          'shijifxsj','fxzcznl','fxzjscznl','fhl',
          'num','singleweight','totalweight','factory',
          'motornum','motorcapacity','motorxh','remarks'],
          tableMachineflocolumn
        );
      } else if (this.index === 18) {
        this.dataStart(
          ...
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','processnum','density',
          'fineness','bdxs','kjl','xysbscnl','tj','length',
          'ccqd','num','singleweight','totalweight','factory',
          'motornum','motorcapacity','motorxh','remarks'],
          tableMachinecxj);
      } else if (this.index === 19) {
        this.dataStart(
          ...
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','processnum','density',
          'zytime','num','singleweight','totalweight',
          'zdjxz','factory','motornum','motorcapacity',
          'remarks'],
          tableMachinett);
      } else if (this.index === 20) {
        this.dataStart(
          ...
          '电机型号','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','processnum','gkld',
          'bdxs','density','zytime','sjcll','shijicll',
          'fhl','num','singleweight','totalweight',
          'zdjxz','factory','motornum','motorcapacity',
          'motorxh','remarks'],
          tableMachineyc);
      } else if (this.index === 21) {
        this.dataStart(
          ['工程代号','子项代号','作业名称','设备名称',
          '型号','处理量','给矿粒度','波动系数','浓度',
          '作业时间','设计处理量','实际处理量','负荷率',
          '数量','单重','总重','最大检修重','制造厂',
          '电机数量','电机容量','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','processnum','gkld','bdxs',
          'density','zytime','sjcll','shijicll','fhl',
          'num','singleweight','totalweight','zdjxz',
          'factory','motornum','motorcapacity','remarks'],
          tableMachinelc);
      } else if (this.index === 22) {
        this.dataStart(
          ...
          '型号','直径','面积','处理量','波动系数',
          '入料浓度','入料细度','底流浓度','设计定额',
          '实际定额','设备负荷率','絮凝剂添加量','数量',
          '单重','总重','制造厂','电机数量','电机容量',
          '电机型号','絮凝剂添加功率','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','diameter','area',
          'processnum','bdxs','rlnd','rlxd','dlnd',
          'sjde','shijide','sbfhl','xnjtjl','num',
          'singleweight','totalweight','factory',
          'motornum','motorcapacity','motorxh',
          'xnjtjkw','remarks'],
          tableMachinensj);
      } else if (this.index === 23) {
        this.dataStart(
          ...
          '电机数量','电机容量','电机型号','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','processnum','xd',
          'glmj','rlnd','dlnd','lbsf','sjde','shijide',
          'sbfhl','num','singleweight','totalweight',
          'factory','motornum','motorcapacity',
          'motorxh','remarks'],
          tableMachineglj);
      } else if (this.index === 24) {
        this.dataStart(
          ...
          '型号','处理量','细度','入料浓度','排矿浓度',
          '设计定额','实际定额','数量','单重','总重',
          '制造厂','电动机数量','电动机容量','电动机型号',
          '备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','processnum','xd','rlnd',
          'pknd','sjde','shijide','num','singleweight',
          'totalweight','factory','motornum','motorcapacity',
          'motorxh','remarks'],
          tableMachinegzj);
      } else if (this.index === 25) {
        this.dataStart(
          ...
          '型号','流量','实际生产用气量','进口压力',
          '出口压力','数量','单重','总重','制造厂',
          '电机数量','电机容量','电机型号','润滑油站功率',
          '风扇电机容量','单台总功率','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','ll','sjscyql','jkyl',
          'ckyl','num','singleweight','totalweight',
          'factory','motornum','motorcapacity','motorxh',
          'rhyzgl','fsdjrl','dtzkw','remarks'],
          tableMachinegfj);
      } else if (this.index === 26) {
        this.dataStart(
          ['工程代号','子项代号','作业名称','设备名称',
          '型号','排气量','压力','数量','单重','总重',
          '制造厂','电机数量','电机容量','电机型号',
          '空气净化装置','冷冻式干燥器','是否变频','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','pql','yl','num','singleweight',
          'totalweight','factory','motornum','motorcapacity',
          'motorxh','kqjhzz','ldsgzq','sfbp','remarks'],
          tableMachinekyj);
      } else if (this.index === 27) {
        this.dataStart(
          ['工程代号','子项代号','作业名称','设备名称',
          '型号','宽度','长度','高度','处理量','Dmax',
          '数量','单重','总重','制造厂','电机数量',
          '电机容量','电机型号','是否变频','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','width','length','high',
          'processnum','dmax','num','singleweight',
          'totalweight','factory','motornum','motorcapacity',
          'motorxh','sfbp','remarks'],
          tableMachinegljfkj);
      } else if (this.index === 28) {
        this.dataStart(
          ['工程代号','子项代号','起点-终点','编号','规格',
          '输送量','最大粒度','长度','倾角','高度','带速',
          '投影长度','凹弧半径','凸弧半径','拉紧方式',
          '拉紧行程','数量','总重','制造厂','电机数量',
          '电机容量','电机型号','备注'],
          ['projectid','childprojectid','qtoz','code',
          'gg','ssongl','zdld','length','qj','high',
          'ds','tycd','ahbj','thbj','ljfs','ljxc','num',
          'totalweight','factory','motornum','motorcapacity',
          'motorxh','remarks'],
          tableMachinepd);
      } else if (this.index === 29) {
        this.dataStart(
          ...
          '数量','单重','总重','制造厂','电机数量',
          '电机容量','备注'],
          ['projectid','childprojectid','code',
          'equipmentname','xh','sjssl','lxzj',
          'length','num','singleweight','totalweight',
          'factory','motornum','motorcapacity','remarks'],
          tableMachinelxysj);
      } else if (this.index === 30) {
        this.dataStart(
          ...
          '是否变频','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','processnum','bcll','yc',
          'zs','xl','cdfs','ld','num','singleweight',
          'totalweight','factory','motornum','motorcapacity',
          'motorxh','sfbp','remarks'],
          tableMachineb);
      } else if (this.index === 31) {
        this.dataStart(
          ['工程代号','子项代号','作业名称','设备名称',
          '型号','浓度','作业ph','矿浆量','设计搅拌时间',
          '实际搅拌时间','波动系数','直径','高度','数量',
          '单重','总重','制造厂','电机数量','电机容量',
          '电机型号','耐磨防腐要求','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','density','zyph','kjl',
          'sjjbsj','shijijbsj','bdxs','diameter','high',
          'num','singleweight','totalweight','factory',
          'motornum','motorcapacity','motorxh','nmffyq',
          'remarks'],
          tableMachinejbckjx);
      } else if (this.index === 32) {
        this.dataStart(
          ['工程代号','子项代号','作业名称','设备名称',
          '型号','工作等级','主钩起重量','副钩起重重量',
          '抓斗斗容','跨距','提升高度','数量','单重',
          '总重','制造厂','主钩起升电机数量','主钩起升电机容量',
          '主钩起升电机型号','副钩起升电机数量','副钩起升电机容量',
          '副钩起升电机型号','大车运行电机数量','大车运行电机容量',
          '大车运行电机型号','小车运行电机数量','小车运行电机容量',
          '小车运行电机型号','起重机运行电机数量','起重机运行电机容量',
          '起重机运行电机型号','总功率','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','gzdj','zgqzl','fgqzzl',
          'zddr','kj','tsgd','num','singleweight',
          'totalweight','factory','zgqsdjsl','zgqsdjrl',
          'zgqsdjxh','fgqsdjsl','fgqsdjrl','fgqsdjxh',
          'dcyxdjsl','dcyxdjrl','dcyxdjxh','xcyxdjsl',
          'xcyxdjrl','xcyxdjxh','qzjyxdjsl','qzjyxdjrl',
          'qzjyxdjxh','zkw','remarks'],
          tableMachineqzj);
      } else if (this.index === 33) {
        this.dataStart(
          ['工程代号','子项代号','作业名称','设备名称',
          '型号','起重重量','提升高度','数量','单重',
          '总重','制造厂','提升电机数量','提升电机容量',
          '提升电机型号','运行电机数量','运行电机容量',
          '运行电机型号','总功率','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','qzzl','tsgd','num',
          'singleweight','totalweight','factory','tsdjsl',
          'tsdjrl','tsdjxh','yxdjsl','yxdjrl','yxdjxh',
          'zkw','remarks'],
          tableMachinehl);
      } else if (this.index === 34) {
        this.dataStart(
          ...
          '储槽数量','储槽长','储槽宽','储槽高',
          '添加点数'],
          ['projectid','yjzl','yjmc','yjyl',
          'pznd','yjyld','zbcs','zbcsl','zbcgg',
          'ccsl','ccc','cck','ccg','tjds'],
          tableMachineyj);
      } else if (this.index === 35) {
        this.dataStart(
          ['工程代号','子项代号','作业名称',
          ...
          '电机容量','电机型号','备注'],
          ['projectid','childprojectid','operationname',
          'equipmentname','xh','gg','num','singleweight',
          'totalweight','factory','motornum','motorcapacity',
          'motorxh','remarks'],
          tableMachineother);
      } else if (this.index === 36) {
        this.dataStart(
          ['项目编号','子项编号','金属结构件名称',
          '金属结构件数量','单重','总重'],
          ['projectid','childprojectid','jsjgjmc',
          'num','singleweight','totalweight'],
          tableMachinejsjgj);
      } else if (this.index === 37) {
        this.dataStart(
          ...
          '管道长度','管道重量','备注'],
          ['projectid','childprojectid','operationname',
          'code','glqd','glzd','num','gdjz','bz',
          'gdcz','szyl','gdgg','gdcd','gdzl','remarks'],
          tableMachinegd);
      } else if (this.index === 38) {
        this.dataStart(
          ['项目编号','子项编号','阀门名称','介质',
          ...
          '单重','总重','制造厂','电机数量','电机容量',
          '执行机构','备注'],
          ['projectid','childprojectid','fmmc',
          'jz','fmgg','cz','gzyl','num','singleweight',
          'totalweight','factory','motornum','motorcapacity',
          'zxjg','remarks'],
          tableMachinefm);
      } else if (this.index === 39) {
        this.dataStart(
          ...
          '规格','材料','数量','单重','总重','标准',
          '备注'],
          ['projectid','childprojectid','glmc',
          'jcmc','gg','cl','num','singleweight',
          'totalweight','bz','remarks'],
          tableMachineetc);
      }
    },
